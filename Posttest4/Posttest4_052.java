...
public class Posttest4_052 {
    ...
    public static void create() throws IOException{
        ...
        Pemesanan pmsbaru = new Pemesanan(addnama, addpesanan, addjumlah, addjeniskopi, addjumlahGula); 
        ...
        pmsbaru.pesanKopi(addpesanan);
        pmsbaru.pesanKopi(addpesanan, addjumlah);
    }
    ...
    public static void read() throws IOException{
        ...
        for (int i = 0; i < pemesanan.size(); i++) {
            ...
            System.out.println("Anda Memesan : " + pemesanan.get(i).getPesanan());
